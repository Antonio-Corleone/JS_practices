 ...
 *  B4: Tính giá trị trung bình của tổng 5 số trên theo công thức: average = sum/5
...
function averageCalc(){
  ...
  var avg = sum/5;
  var text_ex02 = document.getElementById("result_ex02");
  text_ex02.innerHTML = "Result: " + avg;
}
document.getElementById("btn_ex02").onclick = averageCalc;